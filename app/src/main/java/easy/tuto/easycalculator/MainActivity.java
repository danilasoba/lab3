...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    MaterialButton buttonC,Squareroot,Changesigh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       assignId(Changesigh,R.id.changesigh);
    ...
    private void calculateSquareRoot() {
        ...
        try {
            ...
            String formattedResult = decimalFormat.format(squareRoot);

            // Save the calculated data in solutionTv
            solutionTv.setText(formattedResult);
